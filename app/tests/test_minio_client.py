def test_delete_file(minio_client):
    minio_client.upload_file("testbucket", "test.txt", "app/tests/test.txt")
...
def test_delete_many_files(minio_client):
    minio_client.upload_file("testbucket", "test1.txt","app/tests/test.txt")
    minio_client.upload_file("testbucket", "test2.txt", "app/tests/test.txt")
    minio_client.upload_file("testbucket", "test3.txt", "app/tests/test.txt", )
...
def test_download_file(minio_client):
    minio_client.upload_file("testbucket", "test.txt", "app/tests/test.txt")
    result = minio_client.download_file("testbucket", "test.txt", "app/tests/test.txt")
