...
from description_summary.predict_tgi import run_inference_on_json_tgi, run_evaluate_on_csv
from description_summary.predict_vllm import run_inference_on_json
...
app.command("inference_tgi")(run_inference_on_json_tgi)
app.command("evaluate")(run_evaluate_on_csv)
app.command("deploy_model_sagemaker")(deploy_model)
app.command("inference_vllm")(run_inference_on_json)
